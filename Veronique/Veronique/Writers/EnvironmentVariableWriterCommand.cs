...
{
    /// <summary>
    /// Represents an implementation of the <see cref="IWriterCommand"/> interface setting an environment variable.
    /// </summary>
    [WriterCommand("set-env-var")]
    public class EnvironmentVariableWriterCommand : IWriterCommand
    {
        #region Methods
        ...
        public void Write(string[] parameters)
        {
            ...
            Environment.SetEnvironmentVariable(parameters[0], parameters[1]);
        }
