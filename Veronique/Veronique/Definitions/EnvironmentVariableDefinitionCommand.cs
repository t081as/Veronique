...
{
    /// <summary>
    /// Represents an implementation of the <see cref="IDefinitionCommand"/> interface returning an environment variable.
    /// </summary>
    [DefinitionCommand("env-var")]
    public class EnvironmentVariableDefinitionCommand : IDefinitionCommand
    {
        #region Methods
        ...
        public string Evaluate(string[] parameters)
        {
            ...
            // MSDN: This method will return null if the environment variable does not exist
            return Environment.GetEnvironmentVariable(parameters[0]);
        }
