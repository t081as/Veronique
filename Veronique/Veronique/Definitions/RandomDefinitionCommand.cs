...
{
    /// <summary>
    /// Represents an implementation of the <see cref="IDefinitionCommand"/> interface returning a random number.
    /// </summary>
    [DefinitionCommand("random")]
    public class RandomDefinitionCommand : IDefinitionCommand
    {
        #region Methods
