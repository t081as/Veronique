...
{
    /// <summary>
    /// Represents an implementation of the <see cref="IDefinitionCommand"/> interface returning a timestamp.
    /// </summary>
    [DefinitionCommand("timestamp")]
    public class TimestampDefinitionCommand : IDefinitionCommand
    {
        #region Methods
